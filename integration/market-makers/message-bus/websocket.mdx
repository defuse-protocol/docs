...
NEAR Intents exposes an RCP endpoint for applications to request quotes, and a WebSocket endpoint for market makers/solvers to interact with the Message Bus.
