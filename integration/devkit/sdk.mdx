...
The 1Click SDK provides client libraries in multiple languages for seamless cross-chain token swaps using the [1Click Swap API](/integration/distribution-channels/1click-api/about-1click-api.mdx).
