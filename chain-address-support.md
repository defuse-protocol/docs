...
| **TON**      | - Bounceable (starts with `EQ`) <br> - Non-Bounceable (starts with `UQ`)                                | ✅ Supported           | `EQAWzEKcdnykvXfUNouqdS62tvrp32bCxuKS6eQrS6ISgcLo` (Bounceable) <br> `UQAWzEKcdnykvXfUNouqdS62tvrp32bCxuKS6eQrS6ISgZ8t` (Non-Bounceable) |
