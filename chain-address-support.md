...
| **Aleo**  | - 63-character Bech32 (`aleo1` prefix)            | ✅ Supported           | `aleo1kelm7k8786anyygg788ntlgkx4uqkmkpj7k5ugfuqchd8rnf858sun3qcr` |
...
| **Bitcoin Cash**  | - Legacy P2PKH (`1` prefix) <br> - Legacy P2SH (`3` prefix) <br> - CashAddr P2PKH (`q` prefix) <br> - CashAddr P2SH (`p` prefix) | ✅ Supported           | `1BpEi6DfDAUFd7GtittLSdBeYJvcoaVggu` (Legacy P2PKH) <br> `3CWFddi6m4ndiGyKqzYvsFYagqDLPVMTzC` (Legacy P2SH) <br> `bitcoincash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a` (CashAddr P2PKH) <br> `bitcoincash:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37` (CashAddr P2SH) |
