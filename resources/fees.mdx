...
<Info>
The 50/50 split is the default arrangement. Revenue share terms are negotiable — reach out through the [Partner Dashboard](https://partners.near-intents.org/) to discuss custom terms.
</Info>
...
**Eligible orders:** Real cross-asset swaps (not same-token moves). Only applies while the quote is still **fresh—within about 30 minutes** of when it was issued—and only when there is a **strict improvement** versus what the quote guaranteed (after normal fees on the quote).
